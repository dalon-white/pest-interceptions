  ...
  report_content <- tags$html(
    ...
    tags$body(
      ...
      tags$div(class = "summary",
        tags$p("This report documents a search for pest interceptions in the ARM database."),
      ...
      if (include_methodology) {
        tags$div(class = "section",
          ...
          tags$ol(
            tags$li("Connected to ARM database and retrieved diagnostic results"),
      ...
      tags$div(class = "footer",
        tags$p("Report generated by the ARM Pest Interception Analysis Tool"),
